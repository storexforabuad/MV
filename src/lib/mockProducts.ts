...
export const mockBeautyProducts: BeautyProduct[] = [
    ...
    },
    {
        ...
        price: 9000,
        originalPrice: 13000,
        images: ['https://images.unsplash.com/photo-1616683693504-3ea7ef13f951?w=800&q=80'],
        views: 0,
        createdAt: mockTimestamp(),
        productType: 'beauty',
        subtype: 'skincare',
...
export const mockMediaProducts: (MediaInfluencerProduct | VehicleProduct | FashionProduct | BeautyProduct)[] = [
    // --- PR & COLLAB SERVICES ---
    {
        ...
        images: ['/services/instagram-service.png'],
        views: 0,
        createdAt: mockTimestamp(),
        productType: 'media-influencer',
        subtype: 'service',
    ...
    },
    {
        ...
        price: 75000,
        images: ['/services/tiktok-service.png'],
        views: 0,
        createdAt: mockTimestamp(),
        productType: 'media-influencer',
        subtype: 'service',
    ...
    },
    {
        ...
        price: 400000,
        images: ['/services/youtube-service.png'],
        views: 0,
        createdAt: mockTimestamp(),
        productType: 'media-influencer',
        subtype: 'service',
    ...
    },
    {
        ...
        price: 25000,
        images: ['/services/cross-platform-service.png'],
        views: 0,
        createdAt: mockTimestamp(),
        productType: 'media-influencer',
        subtype: 'service',
