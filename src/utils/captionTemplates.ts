...
📲 Order now: https://tinyurl.com/atlasintl/${storeId}/products/${product.id}
...
View details: https://tinyurl.com/atlasintl/${storeId}/products/${product.id}
...
Shop now: https://tinyurl.com/atlasintl/${storeId}/products/${product.id}
...
📲 Click to order: https://tinyurl.com/atlasintl/${storeId}/products/${product.id}
...
🛒 https://tinyurl.com/atlasintl/${storeId}/products/${product.id}
