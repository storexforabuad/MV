...
📲 Order now: https://tinyurl.com/thelinkinmybio/${storeId}/products/${product.id}
...
View details: https://tinyurl.com/thelinkinmybio/${storeId}/products/${product.id}
...
Shop now: https://tinyurl.com/thelinkinmybio/${storeId}/products/${product.id}
...
📲 Click to order: https://tinyurl.com/thelinkinmybio/${storeId}/products/${product.id}
...
🛒 https://tinyurl.com/thelinkinmybio/${storeId}/products/${product.id}
