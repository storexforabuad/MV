...
📲 Order now: https://${storeName}.bizcon.app/products/${product.id}
...
View details: https://${storeName}.bizcon.app/products/${product.id}
...
Shop now: https://${storeName}.bizcon.app/products/${product.id}
...
📲 Click to order: https://${storeName}.bizcon.app/products/${product.id}
...
🛒 https://${storeName}.bizcon.app/products/${product.id}
