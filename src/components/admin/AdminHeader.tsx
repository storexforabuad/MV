...
const AdminHeader = ({ onLogout, isRefreshing, storeMeta }: AdminHeaderProps) => {
  return (
    <header className="sticky top-0 z-50 bg-white/70 dark:bg-zinc-800/70 backdrop-blur-xl shadow-sm border-b border-gray-200 dark:border-zinc-700 transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
        <div className="flex items-center gap-3">
          <h1 className="text-xl sm:text-2xl font-bold text-zinc-900 dark:text-white tracking-tight">Store Control Center</h1>
