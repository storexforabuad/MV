    ...
    const renderProductCard = (product: Product, scoreData?: ProductScore) => {
        ...
        return (
            <motion.button
                ...
                className={`relative rounded-2xl overflow-hidden bg-white shadow-sm transition-all duration-200 ${isUnavailable ? 'opacity-50 cursor-not-allowed' : 'hover:shadow-md active:scale-[0.98]'
                    }`}
            ...
            >
                ...
                <div className="relative w-full pt-[100%] bg-gray-100">
                    ...
                    {scoreData && scoreData.badge && (
                        <div className="absolute top-2 left-2 backdrop-blur-md bg-white/80 text-gray-900 text-[10px] font-semibold px-2 py-1 rounded-full flex items-center gap-1 shadow-sm border border-gray-200/50">
                ...
                {/* Product Info */}
                <div className="p-3">
                    <h3 className="text-sm font-semibold text-gray-900 line-clamp-2 mb-1.5 leading-tight">
                        {product.name}
                    </h3>
        ...
        <div className="p-4 space-y-4">
            ...
            {suggestedProducts.length > 0 ? (
                ...
                <div className="py-16 text-center">
                    ...
                    <p className="text-sm text-gray-500">Add products to see suggestions</p>
                </div>
            )}
        </div>
    );
        ...
        <div className="p-4 space-y-4">
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full bg-gray-100 rounded-xl pl-10 pr-4 py-2.5 text-[15px] text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all"
                />
            </div>
            ...
            return (
                <div className="flex flex-col items-center justify-center h-full py-16 text-center px-6">
                    <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-gray-100 flex items-center justify-center">
                        <PencilSquareIcon className="w-10 h-10 text-gray-400" />
                    </div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">No Product Selected</h3>
                    <p className="text-sm text-gray-500 mb-6">Select a product from Suggested or All Products</p>
                    <button
        ...
        return (
            <div className="flex flex-col h-full">
                ...
                <div className="p-4 bg-gray-50 border-b border-gray-200 flex-shrink-0">
                    <div className="flex items-center gap-3 bg-white rounded-xl p-3 shadow-sm">
                        ...
                        <div className="flex-1 min-w-0">
                            <h4 className="font-semibold text-[15px] text-gray-900 truncate mb-0.5">{selectedProduct.name}</h4>
                            <p className="text-lg font-bold text-pink-600">₦{selectedProduct.price.toLocaleString()}</p>
                        </div>
                        <button
                            onClick={() => {
                                setSelectedProduct(null);
                            ...
                            className="text-gray-400 hover:text-gray-600 active:scale-90 transition-all p-1"
                        >
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-6 bg-white">
                    {/* Platform Selection - iOS Chips */}
                    <div>
                        <label className="block text-[13px] font-semibold text-gray-700 mb-3 uppercase tracking-wide">
                            Select Platforms
                        </label>
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="flex-1">
                                                <div className={`font-semibold text-[15px] ${isSelected ? 'text-pink-700' : 'text-gray-900'}`}>
                                                    {template.name}
                                                </div>
                                            ...
                                            {isSelected && <CheckIcon className="w-5 h-5 text-pink-600" />}
                                        </div>
                                    </motion.button>
                                );
                            })}
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <textarea
                                ...
                                className="w-full bg-white border-2 border-gray-200 rounded-xl px-4 py-3 text-[15px] text-gray-900 leading-relaxed focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-none"
                                rows={10}
                                placeholder="Your caption will appear here..."
                            />
                            <div className="flex justify-between items-center mt-2 text-xs">
                                <span className="text-gray-500">{finalCaption.length} characters</span>
                                <button
                ...
                <div className="p-4 bg-white border-t border-gray-200 space-y-3 flex-shrink-0">
                    <div className="grid grid-cols-2 gap-3">
                        <motion.button
                            ...
                            className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-blue-500 text-white font-semibold hover:bg-blue-600 transition-all disabled:opacity-40 disabled:cursor-not-allowed shadow-sm"
                            whileTap={{ scale: 0.95 }}
                        >
                            {copiedRecently ? (
                                <>
                        ...
                        <motion.button
                            ...
                            className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-green-500 text-white font-semibold hover:bg-green-600 transition-all disabled:opacity-40 disabled:cursor-not-allowed shadow-sm"
                            whileTap={{ scale: 0.95 }}
                        >
                    ...
                    <motion.button
                        onClick={handleCopyCaption}
                        disabled={!finalCaption || selectedPlatforms.length === 0}
                        className="w-full flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-gradient-to-r from-pink-500 to-red-500 text-white font-bold text-base hover:from-pink-600 hover:to-red-600 transition-all disabled:opacity-40 disabled:cursor-not-allowed shadow-lg"
                        whileTap={{ scale: 0.98 }}
                    >
                    ...
                    <div className="flex min-h-full items-end justify-center md:items-center md:p-0">
                        ...
                        >
                            <Dialog.Panel className="relative flex w-full max-w-2xl transform text-left transition">
                                {/* Full-screen modal with no top radius */}
                                <div className="relative flex w-full h-screen md:h-[90vh] md:rounded-2xl flex-col overflow-hidden bg-gradient-to-b from-white to-gray-50 shadow-2xl">
                                    {/* iOS-style Header with blur */}
                                    <div className="px-4 py-3 flex justify-between items-center border-b border-gray-200 flex-shrink-0 bg-white/80 backdrop-blur-lg">
                                        ...
                                        <button
                                            onClick={handleClose}
                                            className="w-8 h-8 rounded-full hover:bg-gray-100 active:bg-gray-200 flex items-center justify-center transition-all"
                                        >
                                            ...
                                            {[
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={`flex-1 py-2 px-3 text-center font-semibold text-[13px] transition-all z-10 flex items-center justify-center gap-1.5 rounded-lg ${isActive ? 'text-gray-900' : 'text-gray-600 hover:text-gray-800'
                                                            }`}
                                                    >
