    ...
    useEffect(() => {
        const build = async () => {
            ...
            try {
                ...
                setFullUrl(`https://tinyurl.com/thelinkinmybio/${storeId}`);
            }
        };
        build();
    }, [storeLink]);
        ...
        <AnimatePresence>
            {isOpen && (
                ...
                >
                    ...
                    <div className="relative w-full h-full md:h-auto md:max-h-[90vh] md:max-w-md md:rounded-2xl flex flex-col overflow-hidden bg-slate-100 dark:bg-slate-900 text-slate-800 dark:text-slate-100 shadow-2xl z-10">
                        <div className="flex items-center justify-between p-4 border-b border-slate-200 dark:border-slate-800">
                            <h3 className="text-lg font-bold leading-6 flex items-center gap-2">
                                <Share2 size={20} />
                                Share Your Store
                            </h3>
