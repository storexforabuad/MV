...
const features = [
    ...
    },
    {
        ...
        description: 'Exclusive discounts and best prices for Compass 🧭vendors.',
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-white/90 text-sm sm:text-base leading-relaxed max-w-xl">
                                    The Compass 🧭Warehouse is your one-stop sourcing center for quality products and
                                    business equipment at unbeatable prices. As a Compass 🧭vendor, you&apos;ll get exclusive
                        ...
                        >
                            ...
                            <ul className="space-y-3">
                                {[
                                    ...
                                    'Seamless integration with your Compass 🧭store',
