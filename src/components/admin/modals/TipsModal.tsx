  ...
  'growth': [
    {
      ...
      title: 'BizConnect Network Benefits',
    ...
    },
    {
      ...
      description: 'Refer other businesses to join BizConnect and earn rewards! Progress through tiers (Bronze → Silver → Gold) as you refer more vendors. The more they succeed, the more you earn.',
