  ...
  'growth': [
    {
      ...
      title: 'Compass 🧭 Network Benefits',
    ...
    },
    {
      ...
      description: 'Refer other businesses to join Compass 🧭 and earn rewards! Progress through tiers (Bronze → Silver → Gold) as you refer more vendors. The more they succeed, the more you earn.',
