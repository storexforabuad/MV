  ...
  return (
    <div className={`min-h-screen bg-gray-50 dark:bg-slate-900 ${contentOnly ? '' : 'pb-20'}`}>
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-6 space-y-4">
        ...
        <div className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 py-4 px-5 rounded-2xl shadow-sm flex items-center gap-4 relative overflow-hidden animate-pulse">
           ...
           <div className="flex flex-col items-start min-w-0 space-y-2">
             ...
             <div className="h-3 w-40 bg-gray-200 dark:bg-slate-800 rounded-md" />
           </div>
        ...
        <div className="w-full h-[52px] bg-gray-200 dark:bg-slate-800 rounded-2xl animate-pulse" />
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 sm:gap-4">
          {[...Array(8)].map((_, index) => (
            <div
              key={index}
              className="relative min-h-[140px] rounded-[2rem] bg-gray-200 dark:bg-slate-800 animate-pulse overflow-hidden flex flex-col items-center justify-center gap-3 p-4 sm:p-5 shadow-md w-full h-full"
            >
        ...
        >
          <div className="relative w-full h-20">
            ...
            <div className="absolute bottom-0 left-0 right-0 h-20 flex items-center px-4">
              <div className="flex-1 flex justify-center items-center">
                <div className="flex flex-col items-center justify-center h-14 w-14 rounded-lg space-y-1 mt-1">
                  <div className="h-6 w-6 bg-gray-300 dark:bg-slate-600 rounded-md animate-pulse" />
                  <div className="h-2 w-10 bg-gray-300 dark:bg-slate-600 rounded-md animate-pulse mt-1" />
                </div>
              </div>
            ...
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10">
              <div className="w-16 h-16 bg-gray-300 dark:bg-slate-600 rounded-full shadow-lg animate-pulse" />
            </div>
          </div>
        </div>
      )}
