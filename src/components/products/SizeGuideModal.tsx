...
import { NIGERIAN_SIZE_CHART, EUROPEAN_SHOE_CHART } from '../../utils/sizeUtils';
...
interface SizeGuideModalProps {
  ...
  onClose: () => void;
  selectedSize?: string;
  sizeCategory?: 'clothing' | 'shoes'; // NEW: determines which chart to show
}
    ...
    <Modal open={isOpen} onClose={onClose}>
      <div className="flex justify-between items-center mb-4">
        <Dialog.Title as="h3" className="text-lg font-medium leading-6 text-gray-900 dark:text-white">
          {sizeCategory === 'clothing' ? 'Nigerian Standard Size Guide' : 'European Shoe Size Guide'}
        </Dialog.Title>
        <button
          type="button"
