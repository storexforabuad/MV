...
export const FloatingLabelInput: React.FC<{ label: string, value: string | number, onChange: (e: ChangeEvent<HTMLInputElement>) => void, name?: string, id?: string, type?: string, placeholder?: string, required?: boolean }> = ({ label, value, onChange, name, id, type = 'text', placeholder = ' ', required = false }) => {
