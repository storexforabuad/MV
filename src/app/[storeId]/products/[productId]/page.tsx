                  ...
                  {(() => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full relative p-6 sm:p-8 rounded-[2rem] shadow-2xl transition-all hover:scale-[1.02] active:scale-[0.98] group border ${is420Hub ? 'bg-gradient-to-br from-zinc-950/90 via-black to-emerald-950/80 border-emerald-500/30' : 'bg-gradient-to-br from-[#1a1a40] via-[#2d1b4d] to-[#1a1a40] border-amber-500/30'}`}
                      >
                        {/* Promo Badge */}
